          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <UserPlus className="absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-foreground/60" />
                <Input
                  id="name"
                  type="text"
            ...
            <div className="text-center text-sm text-foreground/60">
              ...
              <Link href="/auth/signin" className="text-main hover:underline">
                Sign in
              </Link>
            </div>
          </CardContent>
